...
% \begin{figure}[H]
%     \centering
%     \subfloat[\centering Cuneiform Alphabet \\Image from \citep{a2021_how} \label{subfig:cuneiform}]{{\includegraphics[width=5cm]{Images/cuneiform.jpg}}}%
%     \qquad
%     \subfloat[\centering World's Earliest Music Composition \\Image from \citep{porter_2018_did} \label{subfig:first_song}]{{\includegraphics[width=5cm]{Images/first_song.jpg}}}%
% \end{figure}
...
\end{figure}
\indent Based on the findings of Agrawal et al. (\citeyear{agrawal_2019_using})'s work, the kernel size and the number of filters significantly impact \gls{cnns} accuracy.
...
\begin{figure}[H]
    ...
    \label{fig:rf_result}
\end{figure}
\indent According to Munasinghe (\citeyear{munasinghe_2018_facial}), \gls{rf} Classifier are capable of handling facial expression variability well and without overfitting.
