...
\newacronym{pern}{PERN}{PostgreSQL, Express, React, and Node.js}
...
\input{Conclusion} % Section/Chapter entries can be done in the Main.tex file or in a  
                       % separate tex file for longer and more complex documents
...
\addcontentsline{toc}{chapter}{References / Bibliography} % Adds References Section to Table of Contents
\endgroup
% -------------------  Appendix  ---------------------
\appendix
