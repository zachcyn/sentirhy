...
\begin{longtable}{ |m{1.5cm}|m{3.5cm}|m{7cm}|m{1.5cm}| }
    ...
    \cline{1-1} \cline{3-4}
    NFR14 & Localization and Internationalization & Date and time formats should adapt to the user's selected language and region preferences. & Low \\
    \hline
    ...
    \hline
    NFR20 & \multirow{2}{=}{User Interface Design} & The application must adhere to \gls{wcag} 2.1 AA standards for color contrast, navigability, and text size to ensure accessibility for users with disabilities. & High \\
    \cline{1-1} \cline{3-4}
